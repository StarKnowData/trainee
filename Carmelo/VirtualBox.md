...
![](/images/VirtualBox/7.png)
9. 在存储中添加准备好的镜像文件

![](/images/VirtualBox/8.png)
10. 设置好后点击启动进入虚拟机,虚拟机上的安装同重装系统一样，按提示操作即可

![](/images/VirtualBox/9.png)
...
![](/images/VirtualBox/1.gif)
2. 按提示操作并勾选勾选“写入 `Manifest` 文件”，在许可栏里可以写入备注信息，最后点击导出

![](/images/VirtualBox/2.gif)
3. 点击导出即可

![](/images/VirtualBox/3.gif)
**导入**

点击管理，选择导入虚拟机，选择之前导出的 `ovi` 文件，即可完成导入

![](/images/VirtualBox/4.gif)

## Ubuntu分区

![](/images/VirtualBox/10.png)
